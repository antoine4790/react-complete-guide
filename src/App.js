...
class App extends Component {
  ...
  render() {
      ...
      <div className="App">
        ...
        <Person name={this.state.persons[0].name} age={this.state.persons[0].age} click={this.switchNameHandler.bind(this,'Jacquouillet')}>je ne sais pas quand je suis né</Person>
